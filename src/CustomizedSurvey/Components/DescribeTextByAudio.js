...
const TYPE_NAME = "ziggeodescribetextwithaudio";

export class DescribeTextByAudioModel extends Survey.Question {
    getType() {
        return TYPE_NAME;
    }
    get text() {
...
export class DescribeTextByAudio extends Survey.SurveyElementBase {
    state = {
        recorder: null,
    };
    get question() {
...
Survey.Serializer.addClass(
    ...
    function () {
        return new DescribeTextByAudioModel("");
    },
    "question"
);

Survey.ReactQuestionFactory.Instance.registerQuestion(TYPE_NAME, (props) => {
    return React.createElement(DescribeTextByAudio, props);
});
